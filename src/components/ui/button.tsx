  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        clinical: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary font-semibold",
        "clinical-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary/5",
        "add-to-cart": "bg-primary text-primary-foreground hover:bg-primary/90 shadow-primary font-semibold min-h-[44px]",
        pill: "bg-muted text-muted-foreground hover:bg-muted/80 rounded-full",
        "pill-active": "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full",
      },
      size: {
